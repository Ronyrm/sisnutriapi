...
class Product(db.Model):
    ...
    estoquemin = db.Column(db.NUMERIC(precision=8, asdecimal=True, scale=3))
    estoqueatual = db.Column(db.NUMERIC(precision=8, asdecimal=True, scale=3))
    precocusto = db.Column(db.NUMERIC(precision=8, asdecimal=True, scale=3))
